...
<input type="checkbox" id="coding" name="interest" value="coding" style="width:3vw;height:3vw;"/>
  </div>
  <div style="font-size:27px;">
   ...
   <input type="checkbox" id="music" name="interest" value="music" style="width:3vw;height:3vw;" />
  </div>
</fieldset>
